...
function OpenPharmacyMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'pharmacy', {
		...
		elements = {
			...
			{label = _U('pharmacy_take', _U('Bonamin')), item = 'antibiotico', type = 'slider', value = 1, min = 1, max = 10},
			{label = _U('pharmacy_take', _U('Celestamine')), item = 'antibioticorosacea', type = 'slider', value = 1, min = 1, max = 10},
			{label = _U('pharmacy_take', _U('Solmux')), item = 'sciroppo', type = 'slider', value = 1, min = 1, max = 10},
	}}, function(data, menu)
