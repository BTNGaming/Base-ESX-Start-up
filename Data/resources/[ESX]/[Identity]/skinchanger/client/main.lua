...
RegisterNetEvent('skinchanger:getHolster')
AddEventHandler('skinchanger:getHolster', function(cb)
   cb(
    {
     chain = Character['chain_1'],
     shirt = Character['tshirt_1'],
     sex = Character['sex']
   }
    )
end)

RegisterNetEvent('skinchanger:getSex')
AddEventHandler('skinchanger:getSex', function(cb)
   cb(Character['sex'])
end)
